...
<div class="container">
    ...
    <form method="post" id="store" action="{{ route('app.store') }}">
        @csrf
            ...
            <div class="col">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control @error('nama_karyawan') is-invalid @enderror nama_karyawan"
                        id="nama_karyawan" name="nama_karyawan" autocomplete="off" value="{{old('nama_karyawan')}}">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control w-50 @error('kota') is-invalid @enderror kota" id="kota"
                        name="kota" autocomplete="off" value="{{old('kota')}}">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control w-50 @error('provinsi') is-invalid @enderror provinsi"
                        id="provinsi" name="provinsi" autocomplete="off" value="{{old('provinsi')}}">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number" class="form-control w-50 @error('kode_pos') is-invalid @enderror kode_pos"
                        id="kode_pos" name="kode_pos" autocomplete="off" value="{{old('kode_pos')}}">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="number"
                        class="form-control w-50 @error('nomor_telepon') is-invalid @enderror nomor_telepon"
                        id="no_telepon" name="nomor_telepon" autocomplete="off" value="{{old('nomor_telepon')}}">
                </div>
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="date"
                        ...
                        id="tanggal_masuk" name="tanggal_masuk" autocomplete="off" value="{{old('tanggal_masuk')}}">
                </div>
