...
<body>
    ...
    <nav class="navbar bg-dark border-bottom border-body mb-3" data-bs-theme="dark" data-aos="fade-down"
        data-aos-duration="3000">
        <div class="container-fluid">
            <h5 class="navbar-brand"> <i class="bi bi-people-fill"></i>
                Kelompok 3 </h5>
        </div>
    </nav>
...
validateInput($('.nama_karyawan'), $('.textNamaKaryawan'));
...
validateInput($('.nomor_telepon'), $('.textNoTelepon'));
validateInput($('.email'), $('.textEmail'));
validateInput($('.jabatan'), $('.textJabatan'));
validateInput($('.gaji_pokok'), $('.textGajiPokok'));
validateInput($('.tanggal_masuk'), $('.textTanggalMasuk'));
        });
    </script>
</body>
